...
\hypersetup{
    colorlinks=true,                
    linkcolor=blue,                % Cambiar aquí el color de los enlaces (referencias internas)
    citecolor=NavyBlue,            % Las citas internas en azul oscuro
    urlcolor=NavyBlue,             % Los enlaces URL en azul oscuro
