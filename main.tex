...
\floatstyle{plaintop} % Estilo de flotantes con título en la parte superior
\restylefloat{figure} % Restablece el estilo de las figuras con caption en la parte superior
...
% Estilo del capítulo en el índice
\renewcommand{\cftchapfont}{\bfseries\color{black}}
\renewcommand{\cftchappagefont}{\bfseries\color{black}}

% === Clave: redefinir SOLO lo que se ve en el índice ===
\renewcommand{\cftchappresnum}{CAPÍTULO~\Roman{chapter}} %PODEMOS AGREGAR : PUNTITOS
...
\input{portada.tex} % ES LA PORTADA DE LA TESIS
...
% Redefinir temporalmente para mostrar números romanos en el índice
{
...
\input{glosario.tex} % Este es el glosario de términos
\cleardoublepage
...
\input{Capitulos/ReporteAED.tex} % Este es el reporte de AED
% ---------------------------
% Bibliografía
% ---------------------------
\cleardoublepage
